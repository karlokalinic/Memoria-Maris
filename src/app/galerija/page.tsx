  ...
  return (
    <div className="container mx-auto px-6 py-20 page-enter pt-[72px]">
        <div className="text-center mb-16">
            <h1 className="text-5xl md:text-6xl font-cormorant font-bold text-white">Galerija</h1>
            <p className="mt-3 text-lg text-gray-400 font-lato">Vizualni svijet Kantate.</p>
        </div>
