  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center text-center overflow-hidden bg-black">
      ...
      <div className="relative z-20 px-4 text-white flex flex-col items-center">
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-cormorant font-bold tracking-wider text-shadow-custom chaotic-rotate-n2 glitch">MEMORIA MARIS</h1>
        <p className="mt-4 text-xl md:text-2xl font-special text-white chaotic-rotate-2">Psihološka odiseja kroz olujne vode duše</p>
